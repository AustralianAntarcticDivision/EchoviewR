...
EVRenameLine <- function (EVFile, evLine, newName) {
  ...
  if (is.null(line.check) == FALSE) {
    stop(paste(Sys.time(), "Error: A line already exists with the name", newName, ". Line not renamed", sep = " "))
  }
...
#' EVImportLine(EVFile, pathAndFn = 'C:/Users/Lisa/Desktop/KAOS/lineKAOS.evl')
#' 
#' #Example 2 - rename the imported line
#' EVImportLine(EVFile, pathAndFn='C:/Users/Lisa/Desktop/KAOS/lineKAOS.evl', lineName='Line6' ) 
#'}
